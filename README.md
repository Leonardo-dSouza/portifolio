# Leonardo Cristiano de Souza

<p align="center">
  <img src= "./files/IMG_20260527_112540472_PORTRAIT.jpg" width="300" style="border-radius: 5px;"/>
</p>
...
- [Projetos Desenvolvidos](#projetos-desenvolvidos)
  - [1º Semestre (2024-1) - Scrum Tutor](#1º-semestre-2024-1---scrum-tutor)
  - [2º Semestre (2024-2) - DocEye](#2º-semestre-2024-2---doceye)
  - [3º Semestre (2025-1) - PontoLog](#3º-semestre-2025-1---pontolog)
  - [4º Semestre (2025-2) - Descriptum](#4º-semestre-2025-2---descriptum)
  - [5º Semestre (2026-1) - Orbita](#5º-semestre-2026-1---orbita)
...
| Semestre | Nome do Projeto | Tecnologias | Empresa Parceira | Descrição |
| --- | --- | --- | --- | --- |
...
## 1º Semestre (2024-1) - Scrum Tutor
...
https://github.com/CodeDontBlow/Scrum-Tutor
...
- **Comunicação e Paciência:** Trouxe minha vivência do atendimento direto ao público para auxiliar na conciliação mútua dos meus pares, facilitando um ambiente livre de discussões severas e atritos em nosso próprio grupo.

---

## 2º Semestre (2024-2) - DocEye
...
### Link do Repositório Git
https://github.com/CodeDontBlow/DocEye
...
### Hard Skills
- **Java, POO e JDBC** — Faço com autonomia
- **Configuração Sistêmica VLM (Ollama/Modelfile)** — Faço com autonomia
- **MySQL Script e Estruturação de Tabelas** — Faço com autonomia
- **Prática Escalável de Liderança Ágil** — Faço com autonomia

### Soft Skills
- **Gestão Ágil Interpessoal:** Liderança servidora buscando manter um nível emocional de estabilidade nos meus colegas, prestando socorro técnico no entrosamento perante um paradigma complexo não dominado plenamente por todos.
- **Busca por precisão analítica:** Inúmeras tentativas calmas para adaptar a matemática da rede neural artificial visando que o sistema deixasse de ler nomes ilegíveis de maneira inventada nas extrações rotineiras do documento.
...
Alimentei no banco de suporte por inserções loteáveis (batches) sem travar o processamento da máquina, garantindo esquemas "Star Schema". Resolvendo uma das adversidades geradas pelo volume na retaguarda, aloquei uma estrutura no cache de processamento interno utilizando o **Redis** aplicando táticas com um Script Warm-Up preditivo focado em absorver a alta demanda em estados brasileiros grandes sem arrastar a experiência no frontend, que hospedamos unificado a Let's Crypt na própria EC2.

### Hard Skills
- **ETL (Limpeza massiva) usando Python Pandas** — Faço com autonomia
- **Arquitetura Multidimensional SQL Star Schema** — Faço com autonomia
- **Caching Reativo e Warm-up (Redis)** — Faço com autonomia
- **Implantação de Ambiente Linux / EC2 em Host AWS** — Faço com ajuda

### Soft Skills
- **Visão Pragmática Exaustiva:** Analisar quinze milhões de dados e tratá-los necessita aberturas cautelosas constantes garantindo que, linha por linha, a integridade da receita estava de fato segura sem gerar um único número espúrio corrompido nos relatórios federais extraídos do portal ao término do ETL.
- **Maturidade e Proatividade Diagnóstica:** Enfrentei barreiras estruturais onde os sistemas em testes passavam extrema morosidade de leitura do disco; proativamente absorvi o desafio do I/O-Bound instanciando e aprendendo sobre as mitigações com Redis sem auxílios mastigados em roteiros da disciplina.

---

## 4º Semestre (2025-2) - Descriptum

### Empresa Parceira
A TecSys, atuante direta corporativa orientadora encarregada ao desembaraço analítico legal em comitês fiscais portuários e corporações atreladas à logística dos suprimentos de remessas comerciais do mundo perante à federação aduaneira brasileira.

### Problema
Para internalizar mercadorias ao país, é cobrada normativamente das indústrias comerciais descrições completas precisas e a inserção formal em formulário das referências exatas da Nomenclatura Comum (NCM). Como fabricantes mundiais não seguem uma formatação idêntica de notas, os processos contenciosos das matrizes ocorrem com paralisações totais se o robô ou funcionário decair numa tradução falha da finalidade daquela nota. Uma transcrição textual baseada puramente em localizadores arcaicos padronizados estáticos limitava seriamente a logística devido às multas impiedosas das chancelarias aduaneiras e ao retrabalho rotineiro infindo das importações mundiais.
...
### Link do Repositório Git
https://github.com/CodeDontBlow/pro4tech-Orbita
...
- **Extensão Analítica Arquitetural Futura:** Prover elásticos dimensionais em instanciamento demonstra uma capacidade pragmática em resolver atritos futuros sem o receio das dificuldades nas barreiras introdutórias relativas ao aprofundado campo da infraestrutura Cloud de nível empresarial.
